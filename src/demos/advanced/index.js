...
var demonShadowTexture = PIXI.Texture.from("assets/flameDemonShadow.png");
var demonTexture2 = PIXI.Texture.from("assets/flameDemon2.png");
...
world.on("pointerdown", function (event) {
  ...
  if (ignore["placed shadows"]) shadow.ignoreShadowCaster = demon1.children[0];
});
